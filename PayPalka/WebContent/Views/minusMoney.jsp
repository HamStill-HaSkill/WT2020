...
<html lang="rus">
<head>
    <title>PayPalka Перевод средств</title>
    <meta charset="utf-8">
...
<div class="pay-main">
        <aside class="pay-bar">
            <form name="test" action="MinusMoney" method="post">
                 <p class="pay-font"><b>Номер карты для снятия:</b><br>
                  	<input type="text" name="card_num" size="40" id="field" autocomplete="off" type="text" minlength=1 maxlength=255 value=>
                <p class="pay-font"><b>Номер карты для пополнения:</b><br>
                  	<input type="text" name="add_num" size="40" id="field" autocomplete="off" type="text" minlength=1 maxlength=255 value=>
                  	<p class="pay-font"><b>Сумма перевода:</b><br>
                    <input type="text" name="add_money" size="40" id="field" autocomplete="off" type="text" minlength=1 maxlength=255>
                </p>
            ${data}<br>
            <button type="submit" name="submit" class="pay-btn">Перевести</button>
